...
func TestBuildLatestBindsSnapshotHashAndSequence(t *testing.T) {
	t.Parallel()
	snapshot := []byte(`{"schema_version":1,"sequence":42,"published_at":"2026-07-30T00:00:00Z","source_commit":"0123456789012345678901234567890123456789","min_client_version":"0.0.1","candidates":[{"name":"maven","display_name":"Maven","description":"Build tool","homepage":"https://maven.apache.org/","default_vendor":"apache","vendors":[{"name":"apache","display_name":"Apache","releases":[{"version":"3.9.11","selector":"3.9.11","support_tier":"core","artifacts":[{"artifact_id":"maven-x64","archive_type":"zip","platforms":[{"os":"linux","arch":"x64"}],"url":"https://example.com/maven.zip"}]}]}]}]}`)
